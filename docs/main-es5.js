...
/* harmony import */ var _zxing_ngx_scanner__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @zxing/ngx-scanner */ "./node_modules/@zxing/ngx-scanner/fesm5/zxing-ngx-scanner.js");
...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.onCamerasFound = function (devices) {
        this.availableDevices = devices;
        this.hasDevices = Boolean(devices && devices.length);
    };
    AppComponent.prototype.onCodeResult = function (resultString) {
        this.qrResultString = resultString;
    };
    AppComponent.prototype.onDeviceSelectChange = function (selected) {
        var device = this.availableDevices.find(function (x) { return x.deviceId === selected; });
        this.currentDevice = device || null;
    };
    AppComponent.prototype.onHasPermission = function (has) {
        this.hasPermission = has;
    };
    AppComponent.prototype.onTorchCompatible = function (isCompatible) {
        this.torchAvailable$.next(isCompatible || false);
    };
    AppComponent.prototype.toggleTorch = function () {
        this.torchEnabled = !this.torchEnabled;
    };
    AppComponent.prototype.toggleTryHarder = function () {
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_2__["NgModule"])({
            ...
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_1__["BrowserModule"], _app_ui_module__WEBPACK_IMPORTED_MODULE_3__["AppUiModule"], _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_5__["BrowserAnimationsModule"]],
            providers: [],
...
module.exports = __webpack_require__(/*! D:\senati\qr-reader\qr-s-reader\src\main.ts */"./src/main.ts");
